...
// function to check if tabel exist or not
// all the table name are stored in the file tablenames.txt
...
// fuction to print the fetched data corresponding to the given query
...
// function to print cartesian product of two tables
